...
class HeroSliderClass {
  ...
  _call() {
    ...
    TweenMax.set($(".text-container:not(.text--active) .text-main-wrapper"), {
      xPercent: 100
    });
    TweenMax.set(articleTitle, {
      autoAlpha: 0,
      display: 'none'
    });
    TweenMax.set(articlePara, {
      autoAlpha: 0,
      display: 'none'
    });
    TweenMax.set(articleSubTitle, {
      autoAlpha: 0,
      display: 'none'
    });
    ...
    ********************************/
    ...
    tlOpening
      ...
      .staggerFromTo(($(".text-container.text--active .text-main-wrapper")), 1, {
        xPercent: -100
      }, {
        xPercent: 0,
        ease: Power2.easeInOut
      }, 0.2, "-=1")
      .fromTo(activeLabel, 1, {
        autoAlpha: 0
      }, {
        autoAlpha: 1
      })
    ...
    ********************************/
    ...
    $(".cta--down").click(function () {
      var activeLabel = $(".text--active .text-label");
      var activeSlide = $(".text--active").attr("data-slide");
      ...
      var tlSlideUp = new TimelineMax(),
        ...
        tlMainSlideUp = new TimelineMax({
          onComplete: function () {
            TweenMax.set($(".hero-container"), {
              autoAlpha: 0
            })
          }
        });
      ...
      tlMainSlideUp
        ...
        .to(sliderOverlay, 0.2, {
          autoAlpha: 0,
          onComplete: function () {
            $("body").removeClass("u-blockScroll")
          }
        }, "-=0.5")
        .add("sliderOut")
        .add(tlArticleShow);
    ...
    $('.cta--close').on('click', (evt) => {
      window.location.replace('/');
    });
  }
}

export const heroSliderInstance = new HeroSliderClass();
